...
class MapAlgorithmsTest {
    ...
    */
    ...
    public void testShortestPaths() {
        ...
        assertEquals(Arrays.asList("Porto", "Aveiro", "Leiria", "Lisboa"), paths.get(completeMap.key("Lisboa")), "Path to Lisbon");
        ...
        completeMap.addEdge("Leiria", "Castelo Branco", 170);
        Algorithms.shortestPaths(completeMap, "Porto", Integer::compare, Integer::sum, 0, paths, dists);
        assertEquals(365, dists.get(completeMap.key("Castelo Branco")), "Path between Porto and Castelo Branco should now be 335 Km");
        assertEquals(Arrays.asList("Porto", "Aveiro", "Leiria", "Castelo Branco"), paths.get(completeMap.key("Castelo Branco")), "Path to Castelo Branco");
        ...
        assertEquals(Arrays.asList("Porto", "Aveiro", "Leiria", "Lisboa"), paths.get(completeMap.key("Lisboa")), "Path to Lisboa");
