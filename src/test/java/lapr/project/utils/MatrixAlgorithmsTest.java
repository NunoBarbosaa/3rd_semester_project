...
class MatrixAlgorithmsTest {
    ...
    public void testBreadthFirstSearch() {
        ...
        Assertions.assertNull(graph.Algorithms.BreadthFirstSearch(completeMap, "LX"), "Should be null if vertex does not exist");

        LinkedList<String> path = graph.Algorithms.BreadthFirstSearch(incompleteMap, "Faro");

        assertEquals(1, path.size(), "Should be just one");

        assertEquals("Faro", path.peekFirst());

        path = graph.Algorithms.BreadthFirstSearch(incompleteMap, "Porto");
        ...
        path = graph.Algorithms.BreadthFirstSearch(incompleteMap, "Viseu");
    ...
    public void testDepthFirstSearch() {
        ...
        assertNull(graph.Algorithms.DepthFirstSearch(completeMap, "LX"), "Should be null if vertex does not exist");

        LinkedList<String> path = graph.Algorithms.DepthFirstSearch(incompleteMap, "Faro");
        assertEquals(1, path.size(), "Should be just one");
    ...
    public void testminDistGraph() {
        ...
        MatrixGraph<String,Integer> matrixGraph = graph.Algorithms.minDistGraph(incompleteMap, Integer::compare, Integer::sum);
        MatrixGraph<String,Integer> expResult = new MatrixGraph<String,Integer>(false);
        expResult.addVertex("Porto");
        expResult.addVertex("Braga");
        expResult.addVertex("Vila Real");
        expResult.addVertex("Aveiro");
        expResult.addVertex("Coimbra");
        expResult.addVertex("Leiria");
        expResult.addVertex("Viseu");
        expResult.addVertex("Guarda");
        expResult.addVertex("Castelo Branco");
        expResult.addVertex("Lisboa");
        expResult.addVertex("Faro");
        expResult.addEdge("Porto", "Aveiro", 75);
        expResult.addEdge("Porto", "Braga", 60);
        expResult.addEdge("Porto", "Vila Real", 100);
        expResult.addEdge("Viseu", "Guarda", 75);
        expResult.addEdge("Guarda", "Castelo Branco", 100);
        expResult.addEdge("Aveiro", "Coimbra", 60);
        expResult.addEdge("Coimbra", "Lisboa", 200);
        expResult.addEdge("Coimbra", "Leiria", 80);
        expResult.addEdge("Aveiro", "Leiria", 120);
        expResult.addEdge("Leiria", "Lisboa", 150);
        expResult.addEdge("Porto", "Coimbra", 135);
        expResult.addEdge("Porto", "Lisboa", 335);
        expResult.addEdge("Porto", "Leiria", 195);
        expResult.addEdge("Vila Real", "Braga", 160);
        expResult.addEdge("Aveiro", "Braga", 135);
        expResult.addEdge("Coimbra", "Braga", 195);
        expResult.addEdge("Leiria", "Braga", 255);
        expResult.addEdge("Lisboa", "Braga", 395);
        expResult.addEdge("Aveiro", "Vila Real", 175);
        expResult.addEdge("Coimbra", "Vila Real", 235);
        expResult.addEdge("Leiria", "Vila Real", 295);
        expResult.addEdge("Lisboa", "Vila Real", 435);
        expResult.addEdge("Lisboa", "Aveiro", 260);
        expResult.addEdge("Viseu", "Castelo Branco", 175);


        assertEquals(matrixGraph,expResult);
